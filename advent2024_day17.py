from typing import NamedTuple, Self, Optional, Dict, Tuple, List, Iterable
...
class ProgramState(NamedTuple):
    ...
    @staticmethod
    def from_input(raw: str):
        a, b, c = DIGITS.findall(raw)
        return ProgramState(a=int(a), b=int(b), c=int(c), pc=0)
